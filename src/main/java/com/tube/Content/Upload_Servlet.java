...
@WebServlet(name = "Upload_Servlet", value = "/Upload_Servlet")
...
{
    out.println("<script>alert('Uploaded successful!!'); window.location.replace(\"http://localhost/Login/adminindex.jsp\");</script>");

}
else {
    out.println("<script>alert('Unsuccessfull ?? something went wrong!!'); window.location.replace(\"http://localhost/Login/upload_video_form.jsp\");</script>");
