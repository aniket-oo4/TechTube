        ...
        <header>
          ...
          <nav class="navbar1">
            <ul class="navbar1-nav">
              <li class="logo">
                <a href="index.jsp" class="nav-link">
                  <span class="link-text logo-text" id="mainlogo">
                    <span
                      class="svg-inline--fa fa-angle-double-right fa-w-14 fa-5x">     <%=session.getAttribute("name")%>
                    </span>
                    </span>
              ...
              <li class="nav-item">
                <a href="animals.jsp" class="nav-link">
              ...
              <li class="nav-item">
                <a href="fetchContentServlet" class="nav-link">
              ...
              <li class="nav-item" id="themeButton">
                <a href="Logout" class="nav-link">
                  ...
                  <svg fill="#d5b510" width="241px" height="241px" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#d5b510"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>logout</title> <path d="M0 9.875v12.219c0 1.125 0.469 2.125 1.219 2.906 0.75 0.75 1.719 1.156 2.844 1.156h6.125v-2.531h-6.125c-0.844 0-1.5-0.688-1.5-1.531v-12.219c0-0.844 0.656-1.5 1.5-1.5h6.125v-2.563h-6.125c-1.125 0-2.094 0.438-2.844 1.188-0.75 0.781-1.219 1.75-1.219 2.875zM6.719 13.563v4.875c0 0.563 0.5 1.031 1.063 1.031h5.656v3.844c0 0.344 0.188 0.625 0.5 0.781 0.125 0.031 0.25 0.031 0.313 0.031 0.219 0 0.406-0.063 0.563-0.219l7.344-7.344c0.344-0.281 0.313-0.844 0-1.156l-7.344-7.313c-0.438-0.469-1.375-0.188-1.375 0.563v3.875h-5.656c-0.563 0-1.063 0.469-1.063 1.031z"></path> </g></svg>
                  <span class="link-text">Logout</span>
                </a>
              </li>
            </ul>
  ...
  <img src="media/background/background2.png" alt="">
        ...
        <main>
          ...
          <div class="section2" style="">
                  ...
                  class="style-scope ytd-watch-metadata"><!--css-build:shady--><!--css-build:shady--><a
                    ...
                    <yt-img-shadow id="avatar" width="40" class="style-scope ytd-video-owner-renderer no-transition"
                      ...
                      <img
                        ...
                        src="https://yt3.ggpht.com/Rb2KGoDT-AnXdcvQswmYhPpBx7x_FN2F3fqD8F5fRWlVxfpjgSfM0Lcnj7x42bS4aATHYLma=s88-c-k-c0x00ffffff-no-rj"></yt-img-shadow></a>
                  <div id="upload-info" class="style-scope ytd-video-owner-renderer"><ytd-channel-name id="channel-name"
                      ...
                      <div id="container" class="style-scope ytd-channel-name">
                        <div id="text-container" class="style-scope ytd-channel-name">
                          <yt-formatted-string id="text" link-inherit-color="" title="Web Dev Creative"
            ...
            aria-label="Login and Registration using HTML | CSS | JSP | SERVLET | JDBC | MySQL | JAVA Developer Series 🔥 by ">Login
            and Registration using HTML | CSS | JSP | SERVLET | JDBC | MySQL | JAVA Developer
            Series
            🔥</yt-formatted-string>
