    ...
    <nav class="nav container">
      <div class="nav__data">
         <a href="#" class="nav__logo">
            <i class="ri-planet-line"></i> <img src="media/mainLogo2.jpg  "  alt="" class="svg-inline--fa fa-angle-double-right fa-w-14 fa-5x"></span>
      ...
      <li class="logo">
        <a href="index.jsp" class="nav-link" >
          <span class="link-text logo-text" id="mainlogo">
           <img src="media/mainLogo2.jpg  " alt="" class="svg-inline--fa fa-angle-double-right fa-w-14 fa-5x"></span>
          <svg
            aria-hidden="true"
            focusable="false"
            data-prefix="fad"
...
<div class="video-container">
    <video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
      <source src="media/video1.mp4" type="video/mp4"><!-- websites for video = https://www.videvo.net/ -->
  </video>
  <video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
    <source src="media/video1.mp4" type="video/mp4"><!-- websites for video = https://www.videvo.net/ -->
</video>
...
<video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
  <source src="media/video1.mp4" type="video/mp4"><!-- websites for video = https://www.videvo.net/ -->
</video><video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
  <source src="media/video1.mp4" type="video/mp4"><!-- websites for video = https://www.videvo.net/ -->
</video><video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
  <source src="media/video1.mp4" type="video/mp4"><!-- websites for video = https://www.videvo.net/ -->
</video><video autoplay loop id="video-background" muted style="align-self: center;height: 300px;margin:auto;border:5px solid yellow"><!-- for adding video in background in continue loop-->
